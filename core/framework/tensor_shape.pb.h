...
#ifndef PROTOBUF_INCLUDED_core_2fframework_2ftensor_5fshape_2eproto
#define PROTOBUF_INCLUDED_core_2fframework_2ftensor_5fshape_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_core_2fframework_2ftensor_5fshape_2eproto 
...
namespace google {
namespace protobuf {
template<> ::eutopia::framework::TensorShapeProto* Arena::CreateMaybeMessage<::eutopia::framework::TensorShapeProto>(Arena*);
template<> ::eutopia::framework::TensorShapeProto_Dim* Arena::CreateMaybeMessage<::eutopia::framework::TensorShapeProto_Dim>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace eutopia {
namespace framework {
...
class TensorShapeProto_Dim : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eutopia.framework.TensorShapeProto.Dim) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:eutopia.framework.TensorShapeProto.Dim)
 private:
  ...
  friend struct ::protobuf_core_2fframework_2ftensor_5fshape_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class TensorShapeProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eutopia.framework.TensorShapeProto) */ {
 public:
  TensorShapeProto();
  ...
  ::eutopia::framework::TensorShapeProto_Dim* mutable_dim(int index);
  ::google::protobuf::RepeatedPtrField< ::eutopia::framework::TensorShapeProto_Dim >*
      mutable_dim();
  const ::eutopia::framework::TensorShapeProto_Dim& dim(int index) const;
  ::eutopia::framework::TensorShapeProto_Dim* add_dim();
  const ::google::protobuf::RepeatedPtrField< ::eutopia::framework::TensorShapeProto_Dim >&
      dim() const;
  ...
  // @@protoc_insertion_point(class_scope:eutopia.framework.TensorShapeProto)
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::eutopia::framework::TensorShapeProto_Dim > dim_;
  bool unknown_rank_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_core_2fframework_2ftensor_5fshape_2eproto::TableStruct;
};
...
inline ::google::protobuf::int64 TensorShapeProto_Dim::size() const {
  // @@protoc_insertion_point(field_get:eutopia.framework.TensorShapeProto.Dim.size)
  return size_;
}
inline void TensorShapeProto_Dim::set_size(::google::protobuf::int64 value) {
  
  size_ = value;
  // @@protoc_insertion_point(field_set:eutopia.framework.TensorShapeProto.Dim.size)
}
...
inline const ::std::string& TensorShapeProto_Dim::name() const {
  // @@protoc_insertion_point(field_get:eutopia.framework.TensorShapeProto.Dim.name)
  return name_.Get();
}
inline void TensorShapeProto_Dim::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:eutopia.framework.TensorShapeProto.Dim.name)
}
#if LANG_CXX11
inline void TensorShapeProto_Dim::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:eutopia.framework.TensorShapeProto.Dim.name)
}
#endif
inline void TensorShapeProto_Dim::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:eutopia.framework.TensorShapeProto.Dim.name)
}
inline void TensorShapeProto_Dim::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:eutopia.framework.TensorShapeProto.Dim.name)
}
inline ::std::string* TensorShapeProto_Dim::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:eutopia.framework.TensorShapeProto.Dim.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* TensorShapeProto_Dim::release_name() {
  // @@protoc_insertion_point(field_release:eutopia.framework.TensorShapeProto.Dim.name)
...
inline void TensorShapeProto_Dim::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:eutopia.framework.TensorShapeProto.Dim.name)
}
inline ::std::string* TensorShapeProto_Dim::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:eutopia.framework.TensorShapeProto.Dim.name)
...
inline void TensorShapeProto_Dim::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:eutopia.framework.TensorShapeProto.Dim.name)
}
...
inline ::eutopia::framework::TensorShapeProto_Dim* TensorShapeProto::mutable_dim(int index) {
  // @@protoc_insertion_point(field_mutable:eutopia.framework.TensorShapeProto.dim)
  return dim_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::eutopia::framework::TensorShapeProto_Dim >*
TensorShapeProto::mutable_dim() {
  // @@protoc_insertion_point(field_mutable_list:eutopia.framework.TensorShapeProto.dim)
  return &dim_;
}
inline const ::eutopia::framework::TensorShapeProto_Dim& TensorShapeProto::dim(int index) const {
  // @@protoc_insertion_point(field_get:eutopia.framework.TensorShapeProto.dim)
  return dim_.Get(index);
}
inline ::eutopia::framework::TensorShapeProto_Dim* TensorShapeProto::add_dim() {
  // @@protoc_insertion_point(field_add:eutopia.framework.TensorShapeProto.dim)
  return dim_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::eutopia::framework::TensorShapeProto_Dim >&
TensorShapeProto::dim() const {
  // @@protoc_insertion_point(field_list:eutopia.framework.TensorShapeProto.dim)
  return dim_;
}
...
inline bool TensorShapeProto::unknown_rank() const {
  // @@protoc_insertion_point(field_get:eutopia.framework.TensorShapeProto.unknown_rank)
  return unknown_rank_;
}
inline void TensorShapeProto::set_unknown_rank(bool value) {
  
  unknown_rank_ = value;
  // @@protoc_insertion_point(field_set:eutopia.framework.TensorShapeProto.unknown_rank)
}
...
#endif  // PROTOBUF_INCLUDED_core_2fframework_2ftensor_5fshape_2eproto
