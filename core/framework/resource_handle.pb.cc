...
static void InitDefaultsResourceHandleProto() {
  ...
  {
    void* ptr = &::eutopia::framework::_ResourceHandleProto_default_instance_;
    new (ptr) ::eutopia::framework::ResourceHandleProto();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::eutopia::framework::ResourceHandleProto::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, device_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, container_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, hash_code_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::eutopia::framework::ResourceHandleProto, maybe_type_name_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::eutopia::framework::ResourceHandleProto)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::eutopia::framework::_ResourceHandleProto_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "core/framework/resource_handle.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n$core/framework/resource_handle.proto\022\021"
      "eutopia.framework\"r\n\023ResourceHandleProto"
      "\022\016\n\006device\030\001 \001(\t\022\021\n\tcontainer\030\002 \001(\t\022\014\n\004n"
      "ame\030\003 \001(\t\022\021\n\thash_code\030\004 \001(\004\022\027\n\017maybe_ty"
      "pe_name\030\005 \001(\tB,\n\025org.eutopia.frameworkB\016"
      "ResourceHandleP\001\370\001\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 227);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "core/framework/resource_handle.proto", &protobuf_RegisterTypes);
}
...
ResourceHandleProto::ResourceHandleProto()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:eutopia.framework.ResourceHandleProto)
}
ResourceHandleProto::ResourceHandleProto(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_core_2fframework_2fresource_5fhandle_2eproto::scc_info_ResourceHandleProto.base);
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:eutopia.framework.ResourceHandleProto)
}
ResourceHandleProto::ResourceHandleProto(const ResourceHandleProto& from)
  ...
  // @@protoc_insertion_point(copy_constructor:eutopia.framework.ResourceHandleProto)
}
...
ResourceHandleProto::~ResourceHandleProto() {
  // @@protoc_insertion_point(destructor:eutopia.framework.ResourceHandleProto)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* ResourceHandleProto::descriptor() {
  ::protobuf_core_2fframework_2fresource_5fhandle_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_core_2fframework_2fresource_5fhandle_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:eutopia.framework.ResourceHandleProto)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:eutopia.framework.ResourceHandleProto)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "eutopia.framework.ResourceHandleProto.device"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "eutopia.framework.ResourceHandleProto.container"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "eutopia.framework.ResourceHandleProto.name"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "eutopia.framework.ResourceHandleProto.maybe_type_name"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:eutopia.framework.ResourceHandleProto)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:eutopia.framework.ResourceHandleProto)
  return false;
#undef DO_
}
...
void ResourceHandleProto::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:eutopia.framework.ResourceHandleProto)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:eutopia.framework.ResourceHandleProto)
}

::google::protobuf::uint8* ResourceHandleProto::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:eutopia.framework.ResourceHandleProto)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:eutopia.framework.ResourceHandleProto)
  return target;
}

size_t ResourceHandleProto::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:eutopia.framework.ResourceHandleProto)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:eutopia.framework.ResourceHandleProto)
  GOOGLE_DCHECK_NE(&from, this);
  const ResourceHandleProto* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const ResourceHandleProto>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:eutopia.framework.ResourceHandleProto)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:eutopia.framework.ResourceHandleProto)
    MergeFrom(*source);
  }
}

void ResourceHandleProto::MergeFrom(const ResourceHandleProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:eutopia.framework.ResourceHandleProto)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:eutopia.framework.ResourceHandleProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:eutopia.framework.ResourceHandleProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata ResourceHandleProto::GetMetadata() const {
  protobuf_core_2fframework_2fresource_5fhandle_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_core_2fframework_2fresource_5fhandle_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::eutopia::framework::ResourceHandleProto* Arena::CreateMaybeMessage< ::eutopia::framework::ResourceHandleProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::eutopia::framework::ResourceHandleProto >(arena);
}
}  // namespace protobuf
}  // namespace google
